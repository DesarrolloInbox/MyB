...
// 	(uuid_to_bin(uuid()), "uno", "uno@a", "uno"),
//     (uuid_to_bin(uuid()), "dos", "dos@a", "dos"),
//     (uuid_to_bin(uuid()), "tres", "tres@a", "tres"),
//     (uuid_to_bin(uuid()), "cuatro", "cuatro@a", "cuatro"),
//     (uuid_to_bin(uuid()), "cinco", "cinco@a", "cinco");
